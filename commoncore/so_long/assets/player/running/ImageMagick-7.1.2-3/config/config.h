...
#define LIBRARY_ABSOLUTE_PATH "/usr/local/lib/ImageMagick-7.1.2/"

/* Subdirectory of lib where ImageMagick architecture dependent files are
   installed. */
#define LIBRARY_RELATIVE_PATH "ImageMagick-7.1.2"
...
#define PACKAGE_STRING "ImageMagick 7.1.2-3"
...
#define PACKAGE_VERSION "7.1.2-3"
